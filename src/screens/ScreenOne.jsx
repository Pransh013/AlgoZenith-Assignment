        ...
        <div className="h-full  w-11/12 mx-auto xl:px-16">
          ...
          <div className="pt-8 w-full h-full xl:pt-6 px-4 flex flex-col lg:flex-row items-center relative">
            <div className="sm:px-20 2xl:h-full lg:px-0 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:gap-12 text-center lg:text-left w-full lg:w-1/2 text-white">
              <h1 className="text-3xl sm:text-[34px] xl:text-[40px] 2xl:text-7xl w-full font-bold lg:w-2/3">
                Premium is not for the faint hearted!
              </h1>
              <p className="mt-5 xl:mt-8 2xl:text-3xl">
              ...
              <div className="mt-5 items-center lg:items-start flex flex-col gap-2 2xl:gap-5">
